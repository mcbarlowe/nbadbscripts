...
psql $NBA_CONNECT -f bash_scripts/sql_scripts/player_single_year_rapm_view.sql
echo "`date`[INFO] Building Player Three Year RAPM View"
psql $NBA_CONNECT -f bash_scripts/sql_scripts/player_multi_year_rapm_view.sql
